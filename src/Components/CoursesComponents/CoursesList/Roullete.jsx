  ...
  return (
    <div>
      ...
      <CoursesSection
        ...
        para3="You’ll learn roulette fundamentals, dealer techniques, chip handling, game flow, and industry-standard practices that ensure smooth and engaging gameplay. Our hands-on approach, combined with expert guidance, prepares you to thrive in real-world casinos, cruise ships, and entertainment venues worldwide."
        // timeline
        step1="Introduction to Roulette"
        desc1="Get familiar with the fundamentals of roulette, including the wheel, table layout, betting options, and rules. This step ensures you have a solid grasp of how the game is played from both the player’s and dealer’s perspectives."
        step2="Dealer Techniques"
        desc2="Learn the essential skills of a professional dealer such as chip handling, ball spinning, announcing results, and managing payouts. You’ll also be introduced to dealer etiquette and best practices followed in top casinos."
